...
// Tickets service - Fixed to use assigned_agent_id (UUID) instead of assigned_to (string)
export const ticketsService = {
  ...
  async create(ticket) {
    ...
    const cleanTicket = {
      ...
      assigned_agent_id: ticket.assigned_agent_id || null, // Use assigned_agent_id (UUID)
  ...
  async update(id, updates) {
    ...
    // Remove assigned_to if it exists (not in database schema)
    delete cleanUpdates.assigned_to
    
    // Ensure we use assigned_agent_id for assignment updates
  ...
  // Helper method to reassign tickets using agent IDs (matching the database schema)
